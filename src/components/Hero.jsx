  ...
  return (
    <section id="hero" className="hero-section glass-panel" style={{ 
      ...
      <h2 style={{ fontSize: 'clamp(1.2rem, 3vw, 1.8rem)', fontWeight: 300, color: 'var(--text-muted)', marginBottom: '2rem', maxWidth: '800px', lineHeight: '1.8' }}>
        <span className="text-cyan" style={{fontWeight: 600}}>Cyber Security Engineer</span> | Application Security | Full Stack Developer
      </h2>
      
      <p style={{ maxWidth: '650px', marginBottom: '3rem', fontSize: '1.1rem', color: '#c0cad5' }}>
        I specialize in building secure, scalable applications and fortifying digital infrastructures against sophisticated modern threats.
      </p>
